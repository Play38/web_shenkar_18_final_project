...
function generateRandomName() {
	$fnames = array("עומר","אופיר","דנה","יעקב","עידן","דניאל","מקס","שחר","שוהם","תומר","ליאור","יונית","מירי","לב","נאטסו","לוסי","גריי");
	$lnames = array("כהן","גוטמן","לוי","בן ארי","נודלמן","דקל","רובינשטיין","לוטן","רודיטי","קובלבסקי","אביר","רושו","דראגניל","הארטפיליה","פולבסטר");
	$randomName = '';
	$space = ' ';
